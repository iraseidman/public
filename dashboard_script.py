...
# CARTOON PULL
cartoon_folder = ensure_folder("iraseidman.github.io-main/client/public/Cartoon")
weather_folder = ensure_folder("iraseidman.github.io-main/client/public/Weather")
email_folder = ensure_folder("iraseidman.github.io-main/client/public/Email")
stocks_folder = ensure_folder("iraseidman.github.io-main/client/public/Stocks")
...
cartoon_path = Path("iraseidman.github.io-main/client/public/Cartoon")
...
stocks_filename = os.path.join(
    os.path.dirname(__file__),
    "iraseidman.github.io-main/client/public/Stocks",
    "stocks.csv")
...
os.chdir("iraseidman.github.io-main/client/public")  # Change to your local public folder
